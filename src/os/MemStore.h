...
public:
  struct Object : public RefCountedObject {
    ...
    virtual int read(uint64_t offset, size_t len, bufferlist &bl) = 0;
    virtual int write(uint64_t offset, const bufferlist &bl) = 0;
    virtual int clone(Object *src, uint64_t srcoff, size_t len,
                      uint64_t dstoff) = 0;
  ...
  struct BufferlistObject : public Object {
    ...
    int clone(Object *src, uint64_t srcoff, size_t len,
